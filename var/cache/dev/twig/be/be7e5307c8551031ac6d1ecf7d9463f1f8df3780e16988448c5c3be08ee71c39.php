...
class __TwigTemplate_6afb7bbe37bf1a4ef78d630daafb865effcee84d67b35f0206f6d1e9a3a2d96a extends Template
{
    private $source;
    private $macros = [];
...
<?php if (\$required): ?> required=\"required\"<?php endif ?>
<?php echo \$attr ? ' '.\$view['form']->block(\$form, 'attributes') : '' ?>", "@Framework/Form/widget_attributes.html.php", "/Users/adityajoshi/Sites/the_spacebar/vendor/symfony/framework-bundle/Resources/views/Form/widget_attributes.html.php");
    }
}
